...
3. Sube **los archivos que están dentro de esta carpeta directamente a la raíz del repositorio**. `index.html`, `package.json` y `vercel.json` deben verse en la primera pantalla de GitHub; no deben quedar dentro de otra carpeta.
...
## Corrección 404 de Vercel (v1.1)

Esta versión incluye una ruta explícita de `/` hacia `index.html` y se entrega en un ZIP plano. Al descomprimir, sube directamente el contenido interno al repositorio. En Vercel, deja **Root Directory** vacío (`./`).
